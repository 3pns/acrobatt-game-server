...
func (board *Board) InitPlayers() {
	...
	player0 := Player{0, "Joueur", "blue", player0Pieces, player0StartCubes, []*Square{}}
	...
	player1 := Player{1, "AI-1", "green", player1Pieces, player1StartCubes, []*Square{}}
	...
	player2 := Player{2, "AI-2", "yellow", player2Pieces, player2StartCubes, []*Square{}}
	...
	player3 := Player{3, "AI-3", "red", player3Pieces, player3StartCubes, []*Square{}}
